...
$movie = [
    ...
    'synopsis' => 'In a future where cities move across the land on giant wheels, a young woman joins forces with a dangerous rebel to stop a warlord from destroying the world.',
    'trailer_url' => 'https://www.youtube.com/embed/rKHL5PyAPzs?si=ddCjzAEPfepUJCph',
];
?>
...
<head>
    ...
    <meta name="keywords" content="<?php echo $movie['title']; ?>, Movie, Trailer, Adventure, Fantasy, Science Fiction">
